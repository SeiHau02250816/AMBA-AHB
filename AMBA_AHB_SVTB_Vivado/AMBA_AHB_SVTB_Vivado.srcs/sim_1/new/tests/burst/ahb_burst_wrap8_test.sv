...
// Design Name: ahb_burst_wrap8_test
// Module Name: ahb_burst_wrap8_test
// Project Name: AHB SVTB
// 
// Description:
//    AHB Testbench - Burst Wrap8 Test
//    - Configures environment for burst transactions
//    - Sets up AHB environment and runs main test sequence
//    - Tests burst transfers with wrap4 burst type
//
// Revision:
//    v1.0 - Initial implementation 
//////////////////////////////////////////////////////////////////////////////////

class ahb_burst_wrap8_test;
    ...
    function void write_config_file();
        ...
        int burst_type = 32'b100; // Set burst type to WRAP8
    ...
    task main;
        $display("Task main :: ahb_burst_wrap8_test");
        ahb_env_b.main();
    endtask
endclass