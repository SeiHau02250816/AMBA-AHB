...
// Design Name: ahb_burst_incr4_test
// Module Name: ahb_burst_incr4_test
// Project Name: AHB SVTB
// 
// Description:
//    AHB Testbench - Burst Increment4 Test
//    - Configures environment for burst transactions
//    - Sets up AHB environment and runs main test sequence
//    - Tests burst transfers with incr4 burst type
//
// Revision:
//    v1.0 - Initial implementation 
//////////////////////////////////////////////////////////////////////////////////

class ahb_burst_incr4_test;
    ...
    function void write_config_file();
        ...
        int burst_type = 32'b011; // Set burst type to INCR4
    ...
    task main;
        $display("Task main :: ahb_burst_incr4_test");
        ahb_env_b.main();
    endtask
endclass