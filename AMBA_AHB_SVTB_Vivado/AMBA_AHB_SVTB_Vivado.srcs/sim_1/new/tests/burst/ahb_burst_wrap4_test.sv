...
// Design Name: ahb_burst_wrap4_test
// Module Name: ahb_burst_wrap4_test
// Project Name: AHB SVTB
// 
// Description:
//    AHB Testbench - Burst Wrap4 Test
...
class ahb_burst_wrap4_test;
    ...
    function void write_config_file();
        ...
        int burst_type = 32'b010; // Set burst type to WRAP4
    ...
    task main;
        $display("Task main :: ahb_burst_wrap4_test");
        ahb_env_b.main();
    endtask
endclass