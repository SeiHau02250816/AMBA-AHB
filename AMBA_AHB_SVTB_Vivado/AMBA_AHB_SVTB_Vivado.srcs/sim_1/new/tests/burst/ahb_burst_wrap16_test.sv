...
// Design Name: ahb_burst_wrap16_test
// Module Name: ahb_burst_wrap16_test
// Project Name: AHB SVTB
// 
// Description:
//    AHB Testbench - Burst Wrap16 Test
...
class ahb_burst_wrap16_test;
    ...
    task main;
        $display("Task main :: ahb_burst_wrap16_test");
        ahb_env_b.main();
    endtask
endclass