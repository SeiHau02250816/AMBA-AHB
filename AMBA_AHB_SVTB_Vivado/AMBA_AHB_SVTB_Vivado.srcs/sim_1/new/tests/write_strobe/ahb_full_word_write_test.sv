...
// Design Name: ahb_full_word_write_test
// Module Name: ahb_full_word_write_test
// Project Name: AHB SVTB
// 
// Description:
//    AHB Testbench - Full Word Write Test
//    - Configures environment for a full word write transaction
//    - Sets up AHB environment and runs main test sequence
//    - Tests full 32-bit data bus with all strobes active
//
// Revision:
//    v1.0 - Initial implementation 
//////////////////////////////////////////////////////////////////////////////////

class ahb_full_word_write_test;
    ...
    task main;
        $display("Task main :: ahb_full_word_write_test");
        ahb_env_h.main();
    endtask
